...
def kinetics_check(args, cls_range, target_split):
    root = args.dir
    ...
    print('Checking Kinetics dataset completeness...')
    for split in required_splits:
        ...
        for ci, cls in enumerate(classes_part):
            ...
            for name in video_names:
                ...
                if len(frames) == 0:
                    print(f'ERR: {video_path}: frame_len=0')
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Check Kinetics dataset completeness.')
...
def main():
    ...
    kinetics_check(args, cls_range, split)
