"""
This is a copy of video_utils.py in package torchvision.datasets.
The original interfaces operated with some bugs,
so a few modifications were made in this file to help fix these bugs.
"""
...
import torch
from ._video_opt import _probe_video_from_file, _read_video_from_file
from .video import read_video, read_video_timestamps
